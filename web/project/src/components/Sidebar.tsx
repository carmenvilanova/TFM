    ...
    <div className="w-72 bg-white border-r border-amber-200 flex flex-col shadow-sm">
      <div className="p-4 border-b border-amber-200 bg-gradient-to-r from-red-50 to-amber-50">
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium shadow-md hover:shadow-lg"
        >
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="space-y-2">
          {sessions.map((session) => (
            <div
              key={session.id}
              className={`flex items-center gap-3 p-3 rounded-lg cursor-pointer group transition-all duration-200 ${
